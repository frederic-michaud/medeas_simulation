...
def run_simulation_four_pops(n: int, L: int, theta: float, D1: float,D2: float,D3: float,output_folder):
    ...
    scrm_command = f'{4*n} {L} -t {theta} -I 4 {n} {n} {n} {n} -ej {D1} 2 3 -ej {D2} 1 2 -ej {D3} 4 3 --print-model -l -1 -L'
    scrm_command = f'{4*n} {L} -t {theta} -I 4 {n} {n} {n} {n} -ej {D1} 2 3 -ej {D2} 1 2 -ej {D3} 4 3'
...
for L in Ls:
    ...
    for _ in range(sample_size):
        ...
        run_simulation_four_pops(n, L, theta, D1, D2, D3, output_folder)
