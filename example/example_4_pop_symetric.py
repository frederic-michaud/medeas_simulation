...
plt.legend()
fig.savefig("figure/four_pop_symetric_example_eigenvalue.pdf")
...
def get_dist(i, j, ns):
    ...
    elif (pop_i == 0 and pop_j == 1) or (pop_i == 1 and pop_j == 0):
        distance = t12
    elif (pop_i == 2 and pop_j == 3) or (pop_i == 3 and pop_j == 2):
        distance = t34
    else:
        distance = t13
...
plot_mds(eigenvector, 0, 1, label_given, "figure/four_pop_symetric_example_mds.pdf")
fig, ax = plt.subplots(figsize=(8, 8))
...
plt.savefig("figure/four_pop_symetric_example_distance.pdf")
