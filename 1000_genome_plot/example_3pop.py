...
plt.plot(range(2,1+ns[0]),np.full(ns[0]-1,t11**2),label = "Within first population",**args_plot)
plt.plot(range(1+ns[0],ns[0] + ns[1]),np.full(ns[1]-1,t22**2),label = "Within second population",**args_plot)
plt.plot(range(ns[0] + ns[1],n-1),np.full(ns[2]-1,t33**2),label = "Within third population",**args_plot)
plt.plot(n + 2,0,label = "Constant eigenvector",**args_plot)
plt.xlabel("Eigenvalue index")
plt.ylabel("Eigenvalue")
plt.legend()
fig.savefig("three_pop_example_eigenvalue.pdf")