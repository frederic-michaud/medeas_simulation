...
for L in Ls:
    for D in Ds:
        ...
        for distance in distances:
           all_distances1 = np.append(all_distances1,[[D,distance[0]-1]],axis = 0)
...
ax.plot(range(13),  mean_dist_by_L.values,"_",color = colors[0],markersize=7)
ax.set_xlabel("$D$")
...
plt.savefig("figure/two_pop_different_D.pdf")